 ...
 */
class ArchivesspaceItem extends \ArchivesspaceConnector\Entity\ArchivesspaceItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'item', 'job', 'aspaceApiUrl', 'aspaceTargetPath', 'lastModified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArchivesspaceItem $proxy) {
