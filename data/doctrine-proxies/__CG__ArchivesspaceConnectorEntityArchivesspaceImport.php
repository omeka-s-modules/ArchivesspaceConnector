 ...
 */
class ArchivesspaceImport extends \ArchivesspaceConnector\Entity\ArchivesspaceImport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArchivesspaceImport $proxy) {
    ...
    public function setHierarchyId($hierarchyId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHierarchyId', [$hierarchyId]);

        return parent::setHierarchyId($hierarchyId);
    }
    ...
    public function getHierarchyId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHierarchyId', []);

        return parent::getHierarchyId();
    }
