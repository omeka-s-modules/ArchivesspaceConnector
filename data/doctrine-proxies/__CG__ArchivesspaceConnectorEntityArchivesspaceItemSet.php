...
namespace DoctrineProxies\__CG__\ArchivesspaceConnector\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ArchivesspaceItemSet extends \ArchivesspaceConnector\Entity\ArchivesspaceItemSet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'itemSet', 'job', 'aspaceApiUrl', 'aspaceTargetPath', 'lastModified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArchivesspaceItemSet $proxy) {
    ...
    public function setApiUrl($aspaceApiUrl)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setApiUrl', [$aspaceApiUrl]);

        return parent::setApiUrl($aspaceApiUrl);
    }
    ...
    public function setTargetPath($aspaceTargetPath)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTargetPath', [$aspaceTargetPath]);

        return parent::setTargetPath($aspaceTargetPath);
    }
    ...
    public function getTargetPath()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTargetPath', []);
